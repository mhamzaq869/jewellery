                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <input class="form-control form-control-sm @error('first_name') is-invalid @enderror" id="registerFirstName" type="text" name="first_name" value="{{ old('first_name') }}" autocomplete="name" autofocus placeholder="First Name *" required>
                                  @error('first_name')
                              ...
                              <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('last_name') is-invalid @enderror" id="registerLastName" type="text" name="last_name" value="{{ old('last_name') }}" autocomplete="name" autofocus placeholder="Last Name *" required>
                                    @error('last_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                              ...
                              <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm  @error('password_confirmation') is-invalid @enderror"
                                        id="registerPasswordConfirm" type="password" name="password_confirmation" placeholder="Confirm Password *" required
                                        autocomplete="current-password">
                              ...
                              <div class="col-12 col-md-auto">
                                ...
                                <div class="form-group fs-sm text-muted">
                                  ...
                                  Do you already have an account? <u><a href="{{route('login')}}">{{__('Sign in')}}</a></u>
                                </div>
