<script>
    $("#saveShipAddress").on('click', function() {
        let parameter = {
            _token: "{{ csrf_token() }}",
            country: $("#checkoutShippingAddressCountry").val(),
            address_1: $("#checkoutShippingAddressLineOne").val(),
            address_2: $("#checkoutShippingAddressLineTwo").val(),
            city: $("#checkoutShippingAddressTown").val(),
            zipcode: $("#checkoutShippingAddressZIP").val(),
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == true) {
                    $("#shipping_id").val(response.data.id)
