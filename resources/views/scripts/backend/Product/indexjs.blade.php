        ...
        columns: [
            ...
            },
            {
                render: function(data, type, full, meta) {
                    ...
                    return   `<img src="${root + full.photo}" class="w-75" alt="image">`;
                }
            },
            {
                render: function(data, type, full, meta) {
            ...
            },
            {
                render: function(data, type, full, meta) {
                    if(full.category != null){
                        return `<span class="badge badge-light-primary">${full.category.name}</span>`
                    }else{
                        return '--';
                    }
                }
            ...
            {
                render: function(data, type, full, meta) {
                    if(full.subcategory != null){
                        return `<span class="badge badge-light-secondary">${full.subcategory.name}</span>`
                    }else{
                        return '--';
                    }
                }
            ...
            {
                render: function(data, type, full, meta) {
                    return '$'+full.unit_price;
                }
            },
            {
                render: function(data, type, full, meta) {
                    return '$'+full.admin_product_price;
                }
            },
            {
                render: function(data, type, full, meta) {
            ...
            },
            {
                render: function(data, type, full, meta) {
                    if (full.is_featured == 1) {
                        ...
                        return `<span class="badge badge-light-warning">No</span>`
                    }
                }
            },
            {
                                ...
                                <div class="dropdown ms-50">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="email_more">
                                        <a class="dropdown-item"
                                            href="product/${(full.id != null ? full.id : '-')}/edit">
                                        ...
                                        <a class="dropdown-item w-100 delete-record" type="button" onclick="sendAjaxOnDelete('product/${(full.id != null ? full.id : '-')}/destroy','GET',${full.id},'#product-${full.id}')">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                width="14" height="14"
                                                viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2"
