                                ...
                                <div class="dropdown ms-50">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="email_more">
                                        <a class="dropdown-item"
                                            href="coupon/${(full.id != null ? full.id : '-')}/edit">
                                        ...
                                        <a class="dropdown-item w-100 delete-record" type="button" onclick="sendAjaxOnDelete('coupon/${(full.id != null ? full.id : '-')}/destroy','GET',${full.id},'#coupon-${full.id}')">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                width="14" height="14"
                                                viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2"
