<script>
    ...
    let tt = $('.datatable').DataTable({
        ...
        columns: [
            ...
            {
                render: function(data, type, full, meta) {
                    return capitalizeFirstLetter(full.type);
                }
            },
            {
                render: function(data, type, full, meta) {
            ...
            {
                render: function(data, type, full, meta) {
                    return full.days > 1 ? full.days+' Days' : full.days+' Day';
                }
            },
            {
                render: function(data, type, full, meta) {
                                ...
                                <div class="dropdown ms-50">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="email_more">
                                        <a class="dropdown-item"
                                            href="shipping/${(full.id != null ? full.id : '-')}/edit">
                                        ...
                                        <a class="dropdown-item w-100 delete-record" type="button" onclick="sendAjaxOnDelete('shipping/${(full.id != null ? full.id : '-')}/destroy','GET',${full.id},'#shipping-${full.id}')">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                width="14" height="14"
                                                viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2"
        ...
        buttons: [{
            ...
            },
            {
                ...
                action: function(e, dt, button, config) {
                    window.location = 'shipping/create';
                },
                init: function(api, node, config) {
                    $(node).removeClass('btn-secondary');
                }
