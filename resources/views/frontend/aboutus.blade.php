...
@section('content')
    <!-- BREADCRUMB -->
    @include('layouts.breadcrumb', ['page' => 'About Us'])

    <!-- WELCOME -->
    <section>
        <div class="container">
            <div class="row justify-content-center py-14 bg-cover"
                style="background-image: url({{ asset('img/covers/cover-21.jpg') }});">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-md-6">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('img/products/product-62.jpg') }}" alt="..." class="img-fluid w-50">

                    <!-- Image -->
                    <div class="text-end mt-n13 mt-lg-n15 mb-10 mb-md-0">
                        <img src="{{ asset('img/products/product-63.jpg') }}" alt="..." class="img-fluid w-75">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <!-- Button -->
                    <a class="btn btn-dark" href="{{ route('shop') }}">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-md-6 order-md-2 text-end">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('img/products/product-36.jpg') }}" alt="..." class="img-fluid w-50">

                    <!-- Image -->
                    <div class="text-start mt-n13 mt-lg-n15 mb-10 mb-md-0">
                        <img src="{{ asset('img/products/product-37.jpg') }}" alt="..." class="img-fluid w-75">
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-5">
                    ...
                    <!-- Image -->
                    <img class="img-fluid mb-7" src="{{ asset('img/products/product-116.jpg') }}" alt="...">

                    <!-- Image -->
                    <img class="img-fluid mb-7 mb-md-0" src="{{ asset('img/products/product-117.jpg') }}" alt="...">

                </div>
                <div class="col-12 col-md-6 col-lg-5">

                    <!-- Image -->
                    <img class="img-fluid mb-7 mt-md-12" src="{{ asset('img/products/product-118.jpg') }}" alt="...">

                    <!-- Image -->
                    <img class="img-fluid mb-7 mb-md-0" src="{{ asset('img/products/product-119.jpg') }}" alt="...">
                    ...
                    <div class="flickity-buttons-lg flickity-buttons-offset px-lg-12"
                        ...
                        <blockquote class="blockquote col-12 px-4">
                            <p class="mb-6">
                                ...
                                beginning. Appear seasons the it after whose beginning. Hath can't good life. They're
                                multiply made give divided open, be likeness Cattle be have.
    ...
    <!-- SOCIAL -->
    <section class="pt-12">
        <div class="container bg-h-100" style="background-image: url({{ asset('img/covers/cover-15.jpg') }});">
            <div class="row">
