        ...
        <section>
            <div class="card py-4">
                <div class="card-header">
                    <h2>Shop Slider </h2>
                    <button class="btn btn-outline-primary ml-3" onclick="addSlide('shop_slider')"> +Add Slide</button>
                </div>
                <div class="card-body">
                            ...
                            <div class="container d-flex flex-column">
                                <div class="row align-items-center py-12" style="min-height: 550px;">
                                    <div class="col-12 col-md-6 col-lg-5 col-xl-4 offset-md-1">
                                        ...
                                        <a class="btn btn-dark" href="{{asset('shop'.$banner->link)}}">
