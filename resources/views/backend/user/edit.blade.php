        ...
        <section id="multiple-column-form">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" method="POST" method="{{ route('user.update',[$user->id]) }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input
                                                ...
                                                value="{{ $user->first_name }}" autocomplete="name" autofocus
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input class="form-control @error('last_name') is-invalid @enderror"
                                                ...
                                                value="{{ $user->last_name }}" autocomplete="name" autofocus
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input class="form-control @error('date_of_birth') is-invalid @enderror"
                                                type="date" name="date_of_birth" value="{{$user->date_of_birth}}"
