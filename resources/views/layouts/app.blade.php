        ...
        <li class="list-group-item" id="cart-{{$cart->id}}">
          <div class="row align-items-center">
            <div class="col-4">
              ...
              <!-- Image -->
              <a href="product.html">
                <img class="img-fluid" src="{{asset(insertAtPosition($cart->product->photo))}}" alt="...">
              </a>
            ...
            <div class="col-8">
              ...
              <div class="d-flex align-items-center">
                ...
                <!-- Select -->
                <select class="form-select form-select-xxs w-auto" onchange="cartUpdate({{$cart->id}})">
                    ...
                    <div class="col-12">
                      ...
                      <nav class="nav nav-tabs nav-overflow fs-xs border-bottom border-bottom-lg-0">
                        @foreach ($menu_categories as $i => $category)
                            <a class="nav-link text-uppercase {{$i == 0 ? 'active' : '' }}" data-bs-toggle="tab" href="#{{$category->name}}">
                                {{$category->name}}
                            </a>
                        @endforeach
                    ...
                    <div class="tab-pane fade show active" id="navTab">
                      <div class="container">
                        @if (count($menu_categories) > 0)
                            @php $sub_categories = \DB::table('categories')->where('parent_id',$menu_categories[0]->id)->where('status',1)->get(); @endphp
                            <div class="row">
                                <div class="col-6 col-md">
                                    ...
                                    <ul class="list-styled mb-6 mb-md-0 fs-sm">
                                        ...
                                        <a class="list-styled-link" href="{{route('shop',[$menu_categories[0]->name,$category->name] ) }}">{{$category->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
                                <div class="col-6 col-md">
                                    <ul class="list-styled mb-6 mb-md-0 fs-sm">
                                        ...
                                        <li class="list-styled-item">
                                        <a class="list-styled-link" href="shop.html">{{$category->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
